                        ...
                        : "it" == a
                            ...
                            : "ru" == a
                                ...
                                : "ch" == a
                                    ...
                                    : "fr" == a && (document.getElementById("header-lang-img").src = "~/admin/assets/images/flags/french.svg"),
                localStorage.setItem("language", a),
                null == (l = localStorage.getItem("language")) && r("en"),
                (b = new XMLHttpRequest()).open("GET", "~/admin/assets/lang/" + l + ".json"),
...
<<<<<<< HEAD
                ((c = document.createElement("ul")).innerHTML = '<a href="#" class="logo"><img src="~/admin/assets/img/logo.png" alt="User Image" height="22"></a>'),
